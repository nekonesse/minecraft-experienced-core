...
public class FireArrowEntity extends PersistentProjectileEntity {
	...
	public void tick() {
		...
		if (this.method_48926().isClient) {
			...
			this.method_48926().sendEntityStatus(this, (byte)0);
		}
	}
	...
	private void spawnParticles(int amount) {
		...
		for (int j = 0; j < amount; ++j) {
			this.method_48926().addParticle(ParticleTypes.SMALL_FLAME, this.getParticleX(0.5), this.getRandomBodyY(), this.getParticleZ(0.5), d, e, f);
		}
	}
