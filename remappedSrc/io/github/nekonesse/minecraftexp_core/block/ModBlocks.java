...
public class ModBlocks {
	...
	public static final Block OXIDIZED_COPPER_RAIL = registerBlock("oxidized_copper_rail",
		new OxidizableCopperRailBlock(Oxidizable.OxidationLevel.OXIDIZED,QuiltBlockSettings.copyOf(Blocks.RAIL).sounds(BlockSoundGroup.COPPER)));
	public static final Block WEATHERED_COPPER_RAIL = registerBlock("weathered_copper_rail",
		new OxidizableCopperRailBlock(Oxidizable.OxidationLevel.WEATHERED,QuiltBlockSettings.copyOf(Blocks.RAIL).ticksRandomly(true).sounds(BlockSoundGroup.COPPER)));
	public static final Block EXPOSED_COPPER_RAIL = registerBlock("exposed_copper_rail",
		new OxidizableCopperRailBlock(Oxidizable.OxidationLevel.EXPOSED,QuiltBlockSettings.copyOf(Blocks.RAIL).ticksRandomly(true).sounds(BlockSoundGroup.COPPER)));
	public static final Block COPPER_RAIL = registerBlock("copper_rail",
		new OxidizableCopperRailBlock(Oxidizable.OxidationLevel.UNAFFECTED,QuiltBlockSettings.copyOf(Blocks.RAIL).ticksRandomly(true).sounds(BlockSoundGroup.COPPER)));
