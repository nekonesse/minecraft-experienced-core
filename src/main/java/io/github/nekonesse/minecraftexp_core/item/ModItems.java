...
public class ModItems {
	...
	public static final Item APRICOT_DYE = registerItem("apricot_dye", new Item(new QuiltItemSettings().maxCount(1)));
	public static final Item CRIMSON_DYE = registerItem("crimson_dye", new Item(new QuiltItemSettings().maxCount(1)));
	public static final Item ORCHID_DYE = registerItem("orchid_dye", new Item(new QuiltItemSettings().maxCount(1)));
	public static final Item SPRING_GREEN_DYE = registerItem("spring_green_dye", new Item(new QuiltItemSettings().maxCount(1)));
	public static final Item SKY_DYE = registerItem("sky_dye", new Item(new QuiltItemSettings().maxCount(1)));
	public static final Item CHARTREUSE_DYE = registerItem("chartreuse_dye", new Item(new QuiltItemSettings().maxCount(1)));
